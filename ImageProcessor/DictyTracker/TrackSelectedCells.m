function output = TrackSelectedCells(input)
%---------DESCRIPTION------------------------------------------------------
...
% change Darvin's range from 2:numImg to 1:numImg because first frame is
% not treated separately anymore?
for i = 2:numImg
    ...
    im  = imread([imdir yfiles(i-1+startImg).name]);
